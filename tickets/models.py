...
# t1 = Ticket(pessenger_name= 'A',phone_number= +441,email= 'a.email.com',departure= busstop1,arrival= busstop2,bus_name= bus0)
# t2 = Ticket(pessenger_name= 'B',phone_number= +442,email= 'b.email.com',departure= busstop2,arrival= busstop1,bus_name= bus3)
# t3 = Ticket(pessenger_name= 'C',phone_number= +443,email= 'c.email.com',departure= busstop4,arrival= busstop7,bus_name= bus2)
# t4 = Ticket(pessenger_name= 'D',phone_number= +444,email= 'd.email.com',departure= busstop6,arrival= busstop5,bus_name= bus1)
# t5 = Ticket(pessenger_name= 'E',phone_number= +445,email= 'e.email.com',departure= busstop2,arrival= busstop3,bus_name= bus3)
# t6 = Ticket(pessenger_name= 'F',phone_number= +446,email= 'f.email.com',departure= busstop7,arrival= busstop1,bus_name= bus2)
# t7 = Ticket(pessenger_name= 'G',phone_number= +447,email= 'g.email.com',departure= busstop4,arrival= busstop3,bus_name= bus0)